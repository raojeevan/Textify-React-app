  ...
  return (
    <>
      <div>
        ...
        <button className="btn btn-primary m-2" onClick={toUpperCase}>UpperCase</button>
        <button className="btn btn-primary m-2" onClick={toLowerCase}>LowerCase</button>
        <button className="btn btn-primary m-2" onClick={toggleCase}>ToggleCase</button>
        <button className="btn btn-primary m-2" onClick={capitalizeWords}>Capitalize Words</button>
        <button className="btn btn-primary m-2" onClick={capitalizeSentences}>Capitalize Sentences</button>


        <hr className='my-1' />
        <span>Spaces:</span>
        <button className="btn btn-primary m-2" onClick={removeXspace}>Remove Extra space</button>
        <button className="btn btn-primary m-2" onClick={minify}>Minify</button>
        <button className="btn btn-primary m-2" onClick={addSpaceAfterPunctuation}>Add Space After Punctuation</button>
        <hr className='my-1' />
        <span>Text Reversal:</span>s
        <button className="btn btn-primary m-2" onClick={reverse}>Reverse</button>
        <button className="btn btn-primary m-2" onClick={reverseWords}>Reverse Words</button>
        <hr className='my-1' />
      ...
      <div className="container my-1">
        ...
        <p className='my-1'>Words: {text === '' ? 0 : text.split(' ').length}</p>
